    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.wrapper}>
          <Animated.Text style={styles.title} entering={FadeInRight.delay(300).duration(500)}>Stay Update!</Animated.Text>
          ...
          <Animated.View style={styles.btnWrapper} entering={FadeInDown.delay(1200).duration(500)}>
            <TouchableOpacity
              style={styles.btn}
